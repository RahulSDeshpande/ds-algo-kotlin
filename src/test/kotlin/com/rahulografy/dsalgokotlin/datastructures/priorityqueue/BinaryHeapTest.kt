    ...
    fun testRandomizedPolling() {
        for (i in 0 until LOOPS) {
            ...
            while (!pq1.isEmpty()) {
                ...
                Truth.assertThat(pq1.peek()).isEqualTo(pq2.peek())
                Truth.assertThat(pq1.size).isEqualTo(pq2.size())
                Truth.assertThat(pq2.isMinHeap(0))
            }
        }
    }
